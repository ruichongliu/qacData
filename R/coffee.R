...
#' \describe{
#'    \item{Country.of.Origin}{Country of Origin of Beans}
#'    \item{Company}{Company which made the coffee}
#'    \item{Number.of.Bags}{Number of bags harvested}
#'    \item{In.Country.Partner}{Partner of the Company in the Country of Origin}
#'    \item{Grading.Date}{Date the Coffee was reviewed}
#'    \item{Owner.1}{Owner of the Company or the Company Name}  
#'    \item{Variety}{Variety of Coffee}
#'    \item{Processing.Method}{Method by Which the Beans were Processed}
...
#'    \item{Clean.Cup}{Reviewer's Score of "Transparency of a cup" on a 1-10 scale}
#'    \item{Sweetness}{Reviewer's Score of Sweetness on a 1-10 scale}
#'    \item{Cupper.Points}{Reviewer's Holistic Score of the cup on a 1-10 scale}  
#'    \item{Total.Cup.Points}{Sum of the Reviewer's Scores}
#'    \item{Moisture}{Moisture percentage from Green Analysis}
#'    \item{Category.One.Defects}{Major defects in the beans}
#'    \item{Color}{Color of the Greens}
#'    \item{Category.Two.Defects}{Minor defects in the beans}
...
#' found \href{https://github.com/jldbc/coffee-quality-database}{here}.
#' 
#'@examples
#'summary(coffee)
NULL